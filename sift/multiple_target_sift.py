...
img1 = cv2.imread('./sift_trial/target2.jpeg',0)  #Template Image
img2 = cv2.imread('./sift_trial/shelf2.jpeg',cv2.IMREAD_COLOR) #Search Image
#img_rgb = cv2.imread('./sift_trail/shelf2.jpg') # trainImage

img2 = cv2.imread('sift_trial/shelf2.jpg') # trainImage
img3 = cv2.imread('sift_trial/shelf2.jpg')


plt.imshow(cv2.cvtColor(img2, cv2.COLOR_RGB2GRAY), cmap='gray')
time.sleep(20)
