...
parser.add_argument('--ssh', nargs='*', default=False, type=bool, help='Tell if we are over SSH')
args = parser.parse_args()
args.ssh = True if args.ssh == [] else args.ssh
